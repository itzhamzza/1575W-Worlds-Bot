...
void blueNegAlliance5Ring(){
  colorSortTaskBlue.suspend();
  ladyBrown.move_absolute(-1300,200);
  pros::delay(500);
  ...
  chassis.pid_wait();
  chassis.pid_drive_set(-21.5_in, 60);
  ...
  chassis.pid_wait();
  chassis.pid_drive_set(-63_in, DRIVE_SPEED);
  chassis.pid_wait();
  ladyBrown.move_absolute(500,200);
  pros::delay(300);
}
...
void bluePos6Ring(){
  ...
  chassis.pid_wait_quick();
  intake.move_velocity(-1200);
  chassis.pid_drive_set(18_in, 50, false); 
  pros::delay(1500);
  chassis.drive_imu_reset();
  chassis.pid_turn_set(10_deg, TURN_SPEED);
  pros::delay(150);
  ...
  pros::delay(700);
  //5th ring in
  chassis.pid_drive_set(13_in, 70, false); 
  intake.move_velocity(-1200);
  pros::delay(1500);
  //6th ring in
}
void redPos6Ring(){
  colorSortTaskRed.suspend();
  chassis.pid_drive_set(-25_in, 60);
  chassis.pid_wait_until(-21);
  clamper.set_value(true);
  chassis.pid_wait();
...
void redNeg6Ring(){
  ...
  chassis.pid_turn_set(-25_deg, TURN_SPEED);
  chassis.pid_wait_quick_chain();
  chassis.pid_drive_set(6.3_in, DRIVE_SPEED);
  chassis.pid_wait_quick_chain();
  pros::delay(500);
  //2nd ring in
  chassis.pid_drive_set(-20_in, DRIVE_SPEED);
  ...
  chassis.pid_wait();
  // pros::delay(500);
  chassis.pid_drive_set(18_in, 30, false); 
  pros::delay(1500);
  chassis.pid_drive_set(-15_in, DRIVE_SPEED);
  chassis.pid_wait();
  pros::delay(700);
  //4th ring in
  chassis.pid_drive_set(15_in, 30, false); 
  pros::delay(1500);
  //5th ring in
...
void redNegAlliance5Ring(){
  ...
  chassis.pid_wait();
  // pros::delay(500);
  chassis.pid_drive_set(19_in, 50, false); 
  pros::delay(1500);
  chassis.pid_drive_set(-15_in, DRIVE_SPEED);
  chassis.pid_wait();
  pros::delay(700);
  //4th ring in
  chassis.pid_drive_set(15_in, 50, false); 
  pros::delay(1500);
  //5th ring in
  chassis.drive_imu_reset();
  chassis.pid_turn_set(-10_deg, TURN_SPEED);
